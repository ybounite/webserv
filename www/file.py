...
<body>
    ...
    <p>This is a placeholder file displaying all CGI environment variables.</p>
...
for key in sorted(os.environ.keys()):
    ...
    body.write(f'        <div class="env-var"><span class="key">{key}</span> = <span class="value">{value}</span></div>\n')

body.write("""
    </div>
    
    <footer style="margin-top: 30px; text-align: center; color: #666; font-size: 12px;">
        <p>Generated by CGI script</p>
    </footer>
</body>
</html>
""")

# Get the body content and calculate length
body_content = body.getvalue()
content_length = len(body_content.encode('utf-8'))

# Send complete HTTP response with status line + headers + body
